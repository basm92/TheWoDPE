...
\floatfoot{This table shows various statistics (mean, median, standard deviation, 25th and 75th quantile) of net wealth at the age of death (1000 of 1900 guilders) for politicians according to representative body, and political affiliation. Note that the sample sizes does not add up to the unique amount of \textit{Memories}, since some politicians were members of more than one representative body, and hence, have been taken into account more than once.}
\end{table}